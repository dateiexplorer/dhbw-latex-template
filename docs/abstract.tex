...
\begin{otherlanguage}{ngerman}
	\begin{abstract}
        ...
        Vorlage für Projektarbeiten an der \acrlong{dhbw}. Gleichzeitig wurde
        ...
        \Gls{github}-Repository gelangst du mit folgender \acrshort{url}: 
...
\begin{otherlanguage}{english}
	\begin{abstract}
        ...
        for thesises at the \acrshort{dhbw}. Furthermore this document was
        ...
        directly an \emph{Pull Request} on \Gls{github}, so that this template
        will continue to be constantly improved. You can get to the \Gls{github}
        repository with the following \acrshort{url}: 
		\url{https://github.com/dateiexplorer/dhbw-latex-template}.
	\end{abstract}
\end{otherlanguage}
